...
;;; 尺寸 = N × DPR。VSCodium 默认 editor.fontSize=14（用户 settings 未覆盖），
;;; 此处对齐取 14（2x 屏物理 28px）。ncurses 前端无字体概念，
;;; 调用报错由 ignore-errors 吞掉。
...
(ignore-errors (vs-call :lem "SET-FONT-SIZE" 14))
